...
export const knowledgeTopics = [
  ...
  },
  {
    ...
    title: 'บทความ',
    desc: 'คืนทุนกี่ปี ขออนุญาตโรงงาน สถานีชาร์จ EV และ AC vs DC',
...
export const knowledgeFaqGroups: { title: string; items: SeoFaq[] }[] = [
  {
    ...
    items: [
      ...
      {
        q: 'โซล่าเซลล์อาคารพาณิชย์ต่างจากบ้านและโรงงานอย่างไร?',
        a: 'สำนักงานและร้านค้าใช้ไฟกลางวันสูงเหมือนโรงงานแต่ขนาดมักเล็กกว่า ต้องผ่านเจ้าของอาคารหรือนิติบุคคล รายละเอียดอยู่ที่หน้าโซล่าเซลล์อาคารพาณิชย์',
      },
      {
        q: 'ขั้นตอนขออนุญาตติดโซล่าเซลล์โรงงานมีอะไรบ้าง?',
        a: 'สำรวจไซต์ ออกแบบ จัดแบบไฟฟ้าและโครงสร้าง แล้วยื่น MEA หรือ PEA ตามพื้นที่ รายละเอียดอยู่ที่บทความขั้นตอนขออนุญาต และคู่มือโรงงาน',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'AC เหมาะที่จอดนาน เช่น บ้านและโรงแรมค้างคืน DC Fast เหมาะจุดแวะที่ใช้เวลาสั้น รายละเอียดอยู่ที่บทความเปรียบเทียบ AC vs DC',
      },
      {
        q: 'ติดตั้ง EV Charger คอนโดได้ไหม?',
        a: 'ได้หากนิติบุคคลอนุญาตและมิเตอร์อาคารรองรับ ดูหน้า EV Charger สำหรับธุรกิจ แล้วให้ทีมสำรวจตู้ MDB',
      },
    ],
  },
]
