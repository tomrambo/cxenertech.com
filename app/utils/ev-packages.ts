...
export const TRANSFORMER_SIZING: Array<{
  ...
  {
    maxTotalKw: 300,
    suggestion: { minKva: 400, maxKva: 500, label: '400–500 kVA', note: 'CX-S4 class' },
  },
  {
    maxTotalKw: 600,
    suggestion: { minKva: 800, maxKva: 1000, label: '800–1,000 kVA', note: 'CX-S10 class' },
  },
  {
    maxTotalKw: 960,
    suggestion: { minKva: 1250, maxKva: 1600, label: '1,250–1,600 kVA', note: 'CX-HUB class' },
  },
]
...
export const packagePresets: PackagePreset[] = [
  {
    ...
    name: 'CX Station S4',
    productType: 'turnkey',
    description: 'สถานี CX Station S4 · 2×120 kW · 4 จุดชาร์จ',
    chargerLines: [{ skuId: 'sku-dc-120', qty: 2, gunsPerUnit: 2 }],
    footprint: { widthM: 12, depthM: 6.5 },
    transformerKva: 400,
    parkingBays: 4,
    referenceCapex: 3670000,
    boqTemplateId: 'boq-cx-s4',
  ...
  },
  {
    ...
    name: 'CX Station Hub',
    productType: 'turnkey',
    description: 'สถานี CX Station Hub · ปรับจำนวนหัว 2–12 ตามพื้นที่',
    chargerLines: [{ skuId: 'sku-hub-cabinet', qty: 1, gunsPerUnit: 2 }],
    footprint: { widthM: 24, depthM: 8 },
    transformerKva: 1250,
    parkingBays: 4,
    referenceCapex: 6390000,
    boqTemplateId: 'boq-cx-hub',
    targetSites: ['gas', 'mall', 'hub', 'parking'],
  },
]
